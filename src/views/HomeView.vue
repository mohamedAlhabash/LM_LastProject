    ...
    <nav id="header" class="w-full z-30 top-0 py-1">
        ...
        <div class="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-1" id="menu">
          <nav>
            <ul class="md:flex items-center justify-between text-base text-gray-700 pt-4 md:pt-0">
              <li><router-link class="inline-block no-underline hover:text-black hover:underline py-2 px-4"
                  to="/cart">Cart</router-link></li>
      ...
      <div class="order-1 md:order-2">
        ...
        <div class="order-2 md:order-3 flex items-center" id="nav-content">
          ...
          <!-- <RouterLink class="inline-block no-underline hover:text-black" to="login"> -->
    ...
    <section class="bg-white py-8">
      ...
      <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
        <div v-for="product in products" :key="product.id">
          <a href="#">
            <img :src="product.image" alt="product 1" class="hover:grow hover:shadow-lg">
            <div class="pt-3 flex items-center justify-between">
              <p class="">{{ product.name }}</p>
              <svg @click="add_to_cart(product.id)" class="h-6 w-6 fill-current text-gray-500 hover:text-black"
    ...
    <section class="bg-white py-8">
      ...
      <div class="container py-8 px-6 mx-auto">
        ...
        <p class="mb-8">Lorem ipsum dolor sit amet, consectetur <a href="#">random link</a> adipiscing elit, sed do
          ...
          vel facilisis volutpat. Vitae aliquet nec ullamcorper sit. Nullam eget felis eget nunc lobortis mattis aliquam.
          In est ante in nibh mauris. Egestas congue quisque egestas diam in. Facilisi nullam vehicula ipsum a arcu. Nec
          nam aliquam sem et tortor consequat. Eget mi proin sed libero enim sed faucibus turpis in. Hac habitasse platea
          dictumst quisque. In aliquam sem fringilla ut. Gravida rutrum quisque non tellus orci ac auctor augue mauris.
          Accumsan lacus vel facilisis volutpat est velit egestas dui id. At tempor commodo ullamcorper a. Volutpat
          commodo sed egestas egestas fringilla. Vitae congue eu consequat ac.</p>
